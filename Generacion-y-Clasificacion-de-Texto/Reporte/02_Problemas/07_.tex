...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/cesar/Natural-Language-Processing-and-Computer-Vision/Tarea-02/Reporte/Images/CNN/exp_textcnn_f128_do60/confusion_test.png} % Reemplaza con la ruta de tu imagen
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/cesar/Natural-Language-Processing-and-Computer-Vision/Tarea-02/Reporte/Images/CNN/exp_textcnn_f64_k345_do50/confusion_test.png} % Reemplaza con la ruta de tu imagen
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/cesar/Natural-Language-Processing-and-Computer-Vision/Tarea-02/Reporte/Images/CNN/exp_textcnn_k345_f128_lr1e-3/confusion_test.png} % Reemplaza con la ruta de tu imagen
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/cesar/Natural-Language-Processing-and-Computer-Vision/Tarea-02/Reporte/Images/CNN/exp_textcnn_f128_do60/roc_test.png} % Reemplaza con la ruta de tu imagen
        \caption{\texttt{exp\_textcnn\_f128\_do60}}
        \label{fig:roc_exp1}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/cesar/Natural-Language-Processing-and-Computer-Vision/Tarea-02/Reporte/Images/CNN/exp_textcnn_f64_k345_do50/roc_test.png} % Reemplaza con la ruta de tu imagen
        \caption{\protect\texttt{exp\_textcnn\_f64\_k345\_do50}}
        \label{fig:roc_exp2}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{/home/cesar/Natural-Language-Processing-and-Computer-Vision/Tarea-02/Reporte/Images/CNN/exp_textcnn_k345_f128_lr1e-3/roc_test.png} % Reemplaza con la ruta de tu imagen
        \caption{\textbf{\texttt{exp\_textcnn\_k345\_f128\_lr1e-3}}}
        \label{fig:roc_exp3}
    \end{subfigure}
